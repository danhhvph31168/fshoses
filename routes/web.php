...
use App\Http\Controllers\Client\Cart\CheckoutFormController;
...
Route::get('/checkout', [CheckoutFormController::class, 'checkoutForm'])->name('checkout.form');
Route::post('/processCheckout', [CheckoutFormController::class, 'processCheckout'])->name('checkout.store');
