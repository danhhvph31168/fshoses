                            ...
                            <tr class="product">
                                    ...
                                    <div class="product__cart__item__text pt-0">
                                        ...
                                        <div>
                                            <input type="radio" name="product_color" value="{{ $id }}"
                                                id="color-{{ $id }}" class="color-radio" style="display: none;">
                                        </div>
                                        @endforeach
                                        <div class="mb-3 d-flex">
                                            Size: {{ $item['size']['name'] }} -
                                            <div class="d-flex ms-2">
                                                Color:<label class="ms-3" for="color-{{ $id }}" style="
                                                                    width: 20px;
                                                                    height: 20px;
                                ...
                                <td class="quantity__item">
                                    <form action="{{ route('cart.update') }}" method="post">
                                        ...
                                        <div class="quantity">
                                            <div class="pro-qty-2">
                                                <input type="number" id="quatity" name="quatity" class="quantity-input"
                                ...
                                <td class="cart__close">
                                    <form action="{{ route('cart.delItem', $key) }}" method="post">
                                        ...
                                        <button onclick="return confirm('Are you sure?')"
                                            class="border-0 rounded-circle  p-1" style="width: 30px;"><b>x</b></button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
    ...
    <div class="col-lg-4">
        ...
        <div class="cart__total">
            ...
            <ul>
                ...
                <li>Discount: <span class="cart-price total">{{ number_format(session('coupon.value')) }}
                        VNĐ </span></li>
                @else
