                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="province_text" id="province_text" value="{{ $user->province }}">
                                                    @error('province')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="district_text" id="district_text" value="{{ $user->district }}">
                                                    @error('district')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="ward_text" id="ward_text" value="{{ $user->ward }}">
