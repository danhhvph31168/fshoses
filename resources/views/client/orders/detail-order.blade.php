                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-nowrap align-middle table-borderless mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="border-top border-top-dashed">
                                    <td colspan="3">
                                        <textarea class="form-control bg-white" rows="3"
                                            disabled>{{ $order->user_note }}</textarea>
                                    </td>
                                    <td colspan="2" class="fw-medium p-0">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                $shippingCharge = $subTotal < 1000000 ? 50000 : 0; $total=$subTotal -
                                                    $discount + $shippingCharge; @endphp <tr>
                                                    <td>Sub Total :</td>
                                                    <td class="text-end">
                                ...
                                <tr>
                                    @if ($discount)
                                    <td>Discount <span class="text-muted">({{ $order->coupon->name ?? null }})</span>
                                        :
                                    </td>
                                    <td class="text-end">
                ...
                <div class="card-header">
                    <div class="d-sm-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                            ...
                            <button type="button" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0" data-bs-toggle="modal"
                            ...
                            @else
                            <span type="button" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0 fw-bold text-danger"><i
                ...
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('showFormUpdateProfile', Auth::user()->id) }}" class="link-secondary">View
                                Profile</a>
                        </div>
                    </div>
                </div>
