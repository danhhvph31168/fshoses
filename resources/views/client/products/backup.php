                                ...
                                <div class="mt-xl-0 mt-5">
                                    ...
                                    <div class="mt-4 text-muted">
                                        ...
                                        <p>Tommy Hilfiger men striped pink sweatshirt. Crafted with cotton. Material
                                            ...
                                            designer
                                            lifestyle brands and is internationally recognized for celebrating the
                                            essence
                                                                ...
                                                                <div class="border border-dashed rounded p-3">
                                                                    ...
                                                                    <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('theme/admin/assets/images/small/img-12.jpg') }}"
                                                                                alt=""
                                                                                class="avatar-sm rounded object-fit-cover">
                                                                        </a>
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('theme/admin/assets/images/small/img-11.jpg') }}"
                                                                                alt=""
                                                                                class="avatar-sm rounded object-fit-cover">
                                                                        </a>
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('theme/admin/assets/images/small/img-10.jpg') }}"
                                                                                alt=""
                                                                                class="avatar-sm rounded object-fit-cover">
                                                                        </a>
                                                                    </div>
