...
@section('content')
    <section class="shop-details" style="padding: 0; margin-bottom: 10px;">
        <div class="product__details__pic" style="width: 100%; padding: 40px 0 15px; margin-bottom: 0; max-width: 1519.2px;">
            <div class="row">
                <div class="col-lg-12">
                                                        ...
                                                        <div class="pb-3">
                                                            ...
                                                            <div class="text-center">
                                                                <div class="text-muted">
                                                                    Total
                                                                    <span class="fw-medium">{{ number_format($totalRatings) }}</span>
                                                                    reviews
                                                                </div>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <div class="p-2">
                                                                            <div class="progress animated-progress progress-sm">
                                                                                <div class="progress-bar bg-success"
                                                                                     ...
                                                                                     aria-valuenow="{{ $totalRatings ? ($count / $totalRatings) * 100 : 0 }}"
                                                                                     aria-valuemin="0"
                                                ...
                                                <li class="py-2">
                                                    <div class="border border-dashed rounded p-3">
                                                        <div class="d-flex align-items-start mb-3">
                                                            <div class="hstack gap-3">
                                                                <div class="badge rounded-pill bg-success mb-0">
                                                                    <i class="mdi mdi-star"></i> {{ $rating->value }}
                                                                </div>
                                                                <div class="vr"></div>
                                                                <div class="flex-grow-1">
                                                        ...
                                                        <div class="d-flex align-items-end">
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-14 mb-0">{{ $rating->user->name }}</h5>
                                                            </div>
                                        ...
                                        <li class="py-2">
                                            <div class="border border-dashed rounded p-3">
                                                ...
                                                @foreach ($comments as $item)
                                                    <form action="{{ route('destroyComment', $item) }}" method="post"
