...
<section class="shop-details" style="margin-left: -210px; margin-right: -210px; margin-bottom: 10px;">
    <div class="product__details__pic" style="width: 100%; padding: 40px 0 15px; margin-bottom: 0;">
        <div class="row">
            <div class="col-lg-12">
                <div class="product__details__breadcrumb">
                    <a href="./index.html">Home</a>
                    <a href="./shop.html">Shop</a>
                    <span style="color:black">NameProduct</span>
                </div>
            </div>
        </div>
    </div>
