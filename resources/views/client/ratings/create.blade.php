    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0">Color: <span class="fw-medium">{{ $order->orderItems->first()->productVariant->color->name }}</span></p>
                <p class="text-muted mb-0">Size: <span class="fw-medium">{{ $order->orderItems->first()->productVariant->size->name }}</span></p>
            </div>
        </div>
        ...
        <form action="{{ route('ratings.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="comment" name="comment" rows="4" placeholder="Hãy chia sẻ cảm nghĩ của bạn về sản phẩm này..." required></textarea>
            </div>
