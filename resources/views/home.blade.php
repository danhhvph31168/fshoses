                ...
                <div class="product__item">
                    ...
                    <div class="product__item__pic set-bg" {{-- data-setbg="{{ Storage::url($item->img_thumbnail) }}"
                        ...
                        <ul class="product__hover">
                            <li><a href="#"><img src="{{ asset('theme/client/img/icon/heart.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('theme/client/img/icon/compare.png') }}" alt="">
                    ...
                    <div class="product__item__text">
                        ...
                        <span class="text-danger text-decoration-line-through">{{ number_format($item->price_regular, 0,
                            ',', '.') }}
                            VNĐ</span>
                    </div>
                </div>
        ...
        <div class="div row product__filter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h5>{{ $item->name }}</h5>
                        <a href="{{ route('productDetail', ['id' => $product->id]) }}" class="add-cart">+ Add To
                            Cart</a>
                        <div class="rating">
                            <i class="fa fa-star-o"></i>
                            <i class="fa fa-star-o"></i>
