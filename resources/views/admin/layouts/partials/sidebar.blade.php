<div class="app-menu navbar-menu">
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('admin.') }}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ asset('theme/admin/assets/images/logo.jpg') }}" alt="" height="100" width="150">
            </span>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAccounts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.users.create') }}" class="nav-link" data-key="t-horizontal">Add
                                    new</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarRoles">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.roles.create') }}" class="nav-link" data-key="t-horizontal">Add
                                    new</a>
                            </li>
                        </ul>
                    </div>
                ...
                {{-- Product Sizes --}}
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProductSizes" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarProductSizes">
                ...
                {{-- Product Colors --}}
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProductColors" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarProductColors">
