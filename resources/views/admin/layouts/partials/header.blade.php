        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger"
                    .merge_file_51zLBr id="topnav-hamburger-icon">
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Search..." autocomplete="off" 
                            .merge_file_51zLBr id="search-options" value="">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-md-none topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        .merge_file_51zLBr id="page-header-search-dropdown" data-bs-toggle="dropdown"
                                ...
                                <div class="form-group m-0">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search ..."
                                            .merge_file_51zLBr aria-label="Recipient's username">
                    ...
                    <div class="ms-1 header-item d-none d-sm-flex">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                           .merge_file_51zLBr data-toggle="fullscreen">
                    ...
                    <div class="ms-1 header-item d-none d-sm-flex">
                        <button type="button" .merge_file_51zLBr
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                             .merge_file_51zLBr id="page-header-notifications-dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0".merge_file_51zLBr
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                            <<<<<<< .merge_file_51zLBr <span><i
                                                                    class="mdi mdi-clock-outline"></i> Just 30 sec
                                                                ago</span>
                                                                =======
                                                                <span><i class="mdi mdi-clock-outline"></i> Just 30 sec
                                                                    ago</span>
                                                                >>>>>>> .merge_file_hxv1Is
                                                        </p><header id="page-topbar">
                                                            <div class="layout-width">
                                                                <div class="navbar-header">
                                                                    <div class="d-flex">
                                                                        <!-- LOGO -->
                            ...
                            <div class="dropdown ms-sm-3 header-item topbar-user">
                                <button type="button" class="btn" id="page-header-user-dropdown"
                                    data-bs-toggle="dropdown" <<<<<<< .merge_file_51zLBr aria-haspopup="true"
                                    aria-expanded="false">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="text-start ms-xl-2">
                                                <span
                                                    ...
                                                    Adame</span>
                                                <span
                                                    class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Founder</span>
                                            </span>
                                        </span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <!-- item-->
                                    <h6 class="dropdown-header">Welcome Anna!</h6>
                                    <<<<<<< .merge_file_51zLBr <form action="{{ route('logout') }}" method="post">
                                        @csrf
