                        ...
                        <div>
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="billinginfo-firstName" class="form-label">Sku</label>
                                    ...
                                    {{-- <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="billinginfo-lastName" class="form-label">Role</label>
                            ...
                            <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel"
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="billinginfo-address" disabled rows="3">{{ $order->user->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- end tab pane -->
