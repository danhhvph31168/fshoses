                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                               id="billinginfo-Name" value="{{ $order->user->name }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                               id="billinginfo-Balance" value="{{ $order->user->balance }}" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="billinginfo-email" class="form-label">Email
                                            <span class="text-muted">Zip Code</span></label>
                                        <input type="email" class="form-control"
                                               id="billinginfo-zip_code" value="{{ $order->user->zip_code }}" disabled>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="billinginfo-address"
                                          disabled rows="3">{{ $order->user->district }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- end tab pane -->
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-check card-radio">
                                            ...
                                            <label class="form-check-label" for="shippingAddress01">
                                                ...
                                                <span class="text-muted fw-normal text-wrap mb-1 d-block">{{ $order->user_address }}</span>
                                                <span class="text-muted fw-normal text-wrap mb-1 d-block">{{ $order->user_email }}</span>
                                                <span class="text-muted fw-normal d-block">{{ $order->user_phone }}</span>
                                            </label>
                                        </div>
                                        <div
                        ...
                        @foreach ($dataProductVariant as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="rounded-circle text-muted mb-0">Color: <i class="ri-checkbox-blank-circle-fill" style="color: {{$item['color']->name}};"></i> Size: {{ $item['size']->name }}</p>
                                    <p class="text-muted mb-0">{{ empty($item['product']->price_sale) ? $item['product']->price_regular : $item['product']->price_sale }} x {{ $item['quantity'] }}</p>
                                </td>
                                <td class="text-end">{{ empty($item['product']->price_sale) ? $item['product']->price_regular : $item['product']->price_sale * $item['quantity']}} VND</td>
                            </tr>
                        @endforeach
                        <tr>
                            <td class="fw-semibold" colspan="2">Sub Total :</td>
                            <td class="fw-semibold text-end">{{ $order->total_amount }} VND</td>
                        </tr>

                        <tr>
                            <td class="fw-semibold" colspan="2">Payment Method :</td>
            ...
            <div class="modal-body">
                <div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="addaddress-Name" placeholder="Enter name" value="{{ $order->user_name }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="addaddress-textarea" placeholder="Enter address"
                                  rows="2">{{ $order->user_address }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="addaddress-Name" class="form-label">User Phone</label>
                        <input type="text" class="form-control" id="addaddress-Name" placeholder="Enter phone no." value="{{ $order->user_phone }}">
                    </div>

                    <div class="mb-3">
                        <label for="email-Name" class="form-label">User Email</label>
                        <input type="text" class="form-control" id="email-Name" placeholder="Enter email" value="{{ $order->user_email }}">
                    </div>
                </div>
            </div>
