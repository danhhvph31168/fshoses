                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Good Morning, DANH ĐẸP ZAI VCL!</h4>
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header border-0 align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Revenue Order Today</h4>
                                <form action="{{ route('admin.dashboard.year') }}" method="post"
                                    class="d-flex align-items-center justify-content-end">
                                    @csrf
                                    <input type="date" name="dateStart" id="" class="form-control border-info"
                                        style="width: 37%;">

                                    <input type="date" name="dateStop" id="" class="form-control border-info"
                                        style="width: 37%;">
                                    ...
                                    <button type="submit" id="subYear" hidden>save</button>
                                </form>
                            </div><!-- end card header -->
                                ...
                                <div class="row g-0 text-center">
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1"><span class="counter-value" data-target="3">0</span>
                                            </h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1"><span class="counter-value" data-target="1">0</span>
                                            </h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                                            ...
                                            <p class="text-muted mb-0">Order Cancel</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
